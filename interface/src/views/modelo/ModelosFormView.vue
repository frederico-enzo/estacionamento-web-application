      ...
      <div class="row d-flex justify-content-center">
        ...
        <div class="col-md-3">
          <div class="d-grid gap-2">
            ...
            <button v-if="form === 'toggle' && modelo.ativo == true" type="button" class="btn btn-danger" @click="onClickExcluir()">
              Excluir
            </button>
            <button v-if="form === 'toggle' && modelo.ativo == false" type="button" class="btn btn-success" @click="onClickAtivar()">
              Ativar
            </button>
          </div>
        </div>
